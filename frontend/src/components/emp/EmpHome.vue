      ...
      <el-header>
        <div class="header-content">
          <div class="header-left">
            <h2>智慧OA</h2>
            <span class="header-greeting">{{ greeting }}, {{ userInfo.name || '员工' }}</span>
          </div>
      ...
      <el-container>
        ...
        <el-aside width="200px">
          ...
          >
            ...
            <el-menu-item index="/emp-home/leave-apply">
              <el-icon><Edit /></el-icon>
              <span>请假申请</span>
            </el-menu-item>
            <el-menu-item index="/emp-home/leave-list">
...
onMounted(async () => {
  ...
  // 如果当前停留在 /emp-home（无子路由），自动跳转到签到页
  if (route.path === '/emp-home') {
    router.replace('/emp-home/sign-in')
  }
})
